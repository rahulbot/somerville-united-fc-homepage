<script>
  ...
  // sourced from https://www.svgrepo.com/svg/424911/instagram-logo-facebook-2
</script>

<div class="icon-container" id="instagram-logo" >
  <svg fill={color} viewBox="0 0 32 32" width={size} height={size} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" {...props}>
    <g>
